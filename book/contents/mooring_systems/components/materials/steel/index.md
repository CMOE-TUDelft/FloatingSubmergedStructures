...
1.	As indicated some materials have very high strength, comparable to steel.
2.	A low weight, in particular when submerged. This needs to be considered for permanent but also for installation conditions.
3.	This would indicate easier installation, but the material needs to be well protected and carefully handled because the fibres can be easily damaged.
4.	Synthetic wires are generally much cheaper than steel wire. As an indication steel wire or chain are around three times as expensive as synthetic wire rope.
5.	An important aspect to understand is the visco-elastic behaviour. When synthetic wire rope is slowly brought under tension, the rope will elongate and when the tension is reduced, the rope will retain a permanent stretch. Once the rope is loaded slowly again even more, it will move to the original strength/strain curve and slowly elongate further. If at a mean tension the rope experiences fast dynamic load variation it will not follow the working curve but experiences a much higher dynamic stiffness. The difference between the slower loading stiffness and the faster dynamic stiffness can be a factor two.    
